    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgendaRecetas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AgendaRecetas_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AgendaRecetas_Recetas_RecetaId",
                        column: x => x.RecetaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgendaRecetas_RecetaId",
                table: "AgendaRecetas",
                column: "RecetaId");

            migrationBuilder.CreateIndex(
                name: "IX_AgendaRecetas_UserId",
                table: "AgendaRecetas",
                column: "UserId");
